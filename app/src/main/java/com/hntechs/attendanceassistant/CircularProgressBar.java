...
public class CircularProgressBar extends ProgressBar{
    ...
    private static final int BG_STROKE_WIDTH = 10;

    private String mTitle = "";
    private String mSubTitle = "";

    private int mStrokeWidth = STROKE_WIDTH;
    private int mBackgroundStrokeWidth = BG_STROKE_WIDTH;
    ...
    public void init(AttributeSet attrs, int style){
        ...
        mBackgroundStrokeWidth = a.getInt(R.styleable.CircularProgressBar_cpb_backgroundStrokeWidth,BG_STROKE_WIDTH);
        a.recycle();
        ...
        mBackgroundColorPaint.setStrokeWidth(mBackgroundStrokeWidth);
